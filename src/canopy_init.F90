...
!-------------------------------------------------------------------------------
    ...
    if(allocated(tleaf_shade24_rst))  tleaf_shade24_rst(:,:,:)   = fillreal
    if(allocated(tleaf_ave24_rst))    tleaf_ave24_rst(:,:,:)     = fillreal
    if(allocated(ppfd_sun24_rst))     ppfd_sun24_rst(:,:,:)      = fillreal
    if(allocated(ppfd_shade24_rst))   ppfd_shade24_rst(:,:,:)    = fillreal
    if(allocated(tleaf_sun240_rst))   tleaf_sun240_rst(:,:,:)    = fillreal
    if(allocated(tleaf_shade240_rst)) tleaf_shade240_rst(:,:,:)  = fillreal
    if(allocated(tleaf_ave240_rst))   tleaf_ave240_rst(:,:,:)    = fillreal
    if(allocated(ppfd_sun240_rst))    ppfd_sun240_rst(:,:,:)     = fillreal
    if(allocated(ppfd_shade240_rst))  ppfd_shade240_rst(:,:,:)   = fillreal
    if(allocated(tmp2mref_rst))       tmp2mref_rst(:,:)          = fillreal
    if(allocated(ubzref_rst))         ubzref_rst(:,:)            = fillreal
    ...
    if(allocated(tleaf_sun24_rst_3d))    tleaf_sun24_rst_3d(:,:,:,:)     = fillreal
    if(allocated(tleaf_shade24_rst_3d))  tleaf_shade24_rst_3d(:,:,:,:)   = fillreal
    if(allocated(tleaf_ave24_rst_3d))    tleaf_ave24_rst_3d(:,:,:,:)     = fillreal
    if(allocated(ppfd_sun24_rst_3d))     ppfd_sun24_rst_3d(:,:,:,:)      = fillreal
    if(allocated(ppfd_shade24_rst_3d))   ppfd_shade24_rst_3d(:,:,:,:)    = fillreal
    if(allocated(tleaf_sun240_rst_3d))   tleaf_sun240_rst_3d(:,:,:,:)    = fillreal
    if(allocated(tleaf_shade240_rst_3d)) tleaf_shade240_rst_3d(:,:,:,:)  = fillreal
    if(allocated(tleaf_ave240_rst_3d))   tleaf_ave240_rst_3d(:,:,:,:)    = fillreal
    if(allocated(ppfd_sun240_rst_3d))    ppfd_sun240_rst_3d(:,:,:,:)     = fillreal
    if(allocated(ppfd_shade240_rst_3d))  ppfd_shade240_rst_3d(:,:,:,:)   = fillreal
    if(allocated(tmp2mref_rst_3d))       tmp2mref_rst_3d(:,:,:)          = fillreal
    if(allocated(ubzref_rst_3d))         ubzref_rst_3d(:,:,:)            = fillreal
