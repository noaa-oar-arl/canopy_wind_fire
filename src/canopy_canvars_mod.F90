...
!-------------------------------------------------------------------------------
    ...
    real(rk), allocatable :: tleaf_shade24_rst   ( : , :, : )          ! Leaf temp for shaded leaves (K)
    real(rk), allocatable :: tleaf_ave24_rst     ( : , :, : )          ! Average Leaf temp for sunlit and shaded leaves (K)
    real(rk), allocatable :: ppfd_sun24_rst      ( : , :, : )          ! PPFD for sunlit leaves (umol phot/m2 s)
    real(rk), allocatable :: ppfd_shade24_rst    ( : , :, : )          ! PPFD for shaded leaves (umol phot/m2 s)
    real(rk), allocatable :: tleaf_sun240_rst    ( : , :, : )          ! Leaf temp for sunlit leaves (K)
    real(rk), allocatable :: tleaf_shade240_rst  ( : , :, : )          ! Leaf temp for shaded leaves (K)
    real(rk), allocatable :: tleaf_ave240_rst    ( : , :, : )          ! Average Leaf temp for sunlit and shaded leaves (K)
    real(rk), allocatable :: ppfd_sun240_rst     ( : , :, : )          ! PPFD for sunlit leaves (umol phot/m2 s)
    real(rk), allocatable :: ppfd_shade240_rst   ( : , :, : )          ! PPFD for shaded leaves (umol phot/m2 s)
    real(rk), allocatable :: tmp2mref_rst        ( : , : )          ! 2-meter (AGL) input reference air temperature (K)
    real(rk), allocatable :: ubzref_rst          ( : , : )          ! 10-meter (AGL) input reference wind speed (m/s)
    ...
    real(rk), allocatable :: tleaf_sun24_rst_3d     ( : , : , : , : )          ! Leaf temp for sunlit leaves (K)
    real(rk), allocatable :: tleaf_shade24_rst_3d   ( : , : , : , : )          ! Leaf temp for shaded leaves (K)
    real(rk), allocatable :: tleaf_ave24_rst_3d     ( : , : , : , : )          ! Average Leaf temp for sunlit and shaded leaves (K)
    real(rk), allocatable :: ppfd_sun24_rst_3d      ( : , : , : , : )          ! PPFD for sunlit leaves (umol phot/m2 s)
    real(rk), allocatable :: ppfd_shade24_rst_3d    ( : , : , : , : )          ! PPFD for shaded leaves (umol phot/m2 s)
    real(rk), allocatable :: tleaf_sun240_rst_3d    ( : , : , : , : )          ! Leaf temp for sunlit leaves (K)
    real(rk), allocatable :: tleaf_shade240_rst_3d  ( : , : , : , : )          ! Leaf temp for shaded leaves (K)
    real(rk), allocatable :: tleaf_ave240_rst_3d    ( : , : , : , : )          ! Average Leaf temp for sunlit and shaded leaves (K)
    real(rk), allocatable :: ppfd_sun240_rst_3d     ( : , : , : , : )          ! PPFD for sunlit leaves (umol phot/m2 s)
    real(rk), allocatable :: ppfd_shade240_rst_3d   ( : , : , : , : )          ! PPFD for shaded leaves (umol phot/m2 s)
    real(rk), allocatable :: tmp2mref_rst_3d        ( : , : , : )              ! 2-meter (AGL) input reference air temperature (K)
    real(rk), allocatable :: ubzref_rst_3d          ( : , : , : )              ! 10-meter (AGL) input reference wind speed (m/s)
