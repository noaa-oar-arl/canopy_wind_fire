...
! Species-Dependent Parameterized Canopy Model Parameters (Table 4 of Guenther et al., 2012)
        ...
        REAL(RK),          PARAMETER     :: CHW_LIMO         =  1.0_rk     !coefficient for high wind stress
        ...
        REAL(RK),          PARAMETER     :: CHW_BPIN         =  1.0_rk     !coefficient for high wind stress
        ...
        REAL(RK),          PARAMETER     :: CHW_MONO         =  1.0_rk     !coefficient for high wind stress
        ...
        REAL(RK),          PARAMETER     :: CHW_CARY         =  1.0_rk     !coefficient for high wind stress
