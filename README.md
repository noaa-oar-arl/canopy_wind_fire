...
| `aq_opt`       | user-set options for applying an air quality stressn factor for biogenic emissions using calculated, spatially-dependent and global GFS-based ozone W126 values (= `0`, default) or a constant user-set W126 value (= `1`). To turn off aq stress factor set `aq_opt=2`  |
